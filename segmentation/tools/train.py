...
def main(config):
    import torch
    from segmentation.models import build_model, build_loss
    from segmentation.data_loader import get_dataloader
    from segmentation.trainer import Trainer
    from segmentation.post_processing import get_post_processing
    from segmentation.utils import get_metric
...
if __name__ == '__main__':
    ...
    from segmentation.utils import parse_config
